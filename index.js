...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    document.querySelector(".zoom-box").classList.add("zoom-in");
  }, 4000); // Zoom in after 4 seconds

  setTimeout(function () {
    document.querySelector(".zoom-box").classList.remove("zoom-in");
    document.querySelector(".zoom-box").classList.add("zoom-out");
  }, 6000); // Zoom out after 2 seconds
});
